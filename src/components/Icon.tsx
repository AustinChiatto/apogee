...
const icons = {
  ...
  rocket: (
    ...
    >
      <path
        fill-rule="evenodd"
        d="M12.4 15.84c.39.39 1.02.39 1.41 0l6.56-6.57c.95-.96 1.61-2.15 1.92-3.46 .27-1.15.25-2.34-.04-3.48 -.08-.31-.32-.55-.63-.63 -1.14-.3-2.33-.31-3.48-.04 -1.31.3-2.51.97-3.46 1.92l-6.57 6.56c-.4.39-.4 1.02 0 1.41l4.24 4.24Zm3.38-6.76c0 .5-.43.91-.94.91 -.52 0-.94-.41-.94-.91 0-.51.42-.91.94-.91 .51 0 .94.4.94.91Z"
      />
      <g>
        <path d="M10.21 16.93c-.39.19-.86.11-1.16-.19l-1.81-1.81c-.31-.31-.38-.78-.19-1.16l.47-.95c.3-.61 1.11-.75 1.6-.26l2.28 2.28c.48.48.35 1.29-.26 1.6l-.95.47Z" />
        <path d="M9.99 16.48c-.2.09-.43.05-.58-.1L7.6 14.57c-.16-.16-.19-.39-.1-.58l.47-.95c.15-.31.55-.38.8-.13l2.28 2.28c.24.24.17.64-.13.8l-.95.47Zm.44.89l.94-.48c.91-.46 1.11-1.68.38-2.41l-2.29-2.29c-.73-.73-1.95-.53-2.41.38l-.48.94c-.29.57-.18 1.27.28 1.73l1.8 1.8c.45.45 1.15.56 1.73.28Z" />
        <path d="M3.73 16.27c.26-.31.57-.55.93-.73 .35-.18.74-.29 1.14-.31 .39-.03.79.02 1.17.15 .37.13.72.33 1.01.6 .26.29.46.64.6 1.01 .13.37.18.77.15 1.17 -.03.39-.13.78-.31 1.14 -.18.35-.43.67-.73.93 -1.58 1.57-3.95 2.03-5.26 2.17 -.54.05-.98-.38-.92-.92 .13-1.32.6-3.69 2.17-5.26Z" />
      </g>
    </svg>
  )
};
...
const Icon = ({ name, fill = 'primary', size = 'medium' }: Icons) => {
  ...
  return <span className={`${sizeValues} grid place-items-center fill-${fill} text-${fill}`}>{icons[name]}</span>;
};
